...
class CLReport
  ...
  def createReport(reportName)
    ...
    @reportContent1 = '<html>
      ...
      <title>dKit Admin Portal Test Report</title>
      <style type=text/css>
      ...
      <td align=right><p class=title>dKit Admin Portal Test Report</p></td>
      </tr>
      </tbody>
      </table>
      <br>
    ...
    @reportContent2 = '</tr>
      ...
      <td class=bborder_right width=60%><p>Description</p></td>
      </tr>'
  ...
  def addtoReport(reportName, step, result, description)
    @reportContent2 = @reportContent + '<tr><td class=border_left width=30%><p class=normal_text>' + step + '</p></td>'
    #@reportContent2 +
    ...
    @reportContent2 = @reportContent2 + '<td class=border_right width=60%><p class=normal_text>' + description + '</p></td></tr>'
  end
  ...
  def finishReport(reportName)
    ...
    @reportContent2 = @reportContent2 + '<tr>
      ...
      <hr width=100% class=border size=1px>
      <br>
      <center><p class=small_text>&copy2012</p></center>
      <br>'
